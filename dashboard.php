      ...
      <div class="container text-center">
        ...
        <nav>
            <ul>
                ...
                <li><a href="view_clients.php">Voir les clients</a></li>
                <li><a href="view_credits.php">Voir les crédits</a></li>
                <li><a href="add_credit.php">Ajouter un crédit</a></li>
            </ul>
        </nav>
        <div class="form-group mt-4 text-center">
                <a href="logout.php"><button type="submit" class="btn-get-started">Se déconnecter</button></a>
              </div>
       </div>
        </div>
      </div>
